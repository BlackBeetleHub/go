...
[Prebuilt binaries](https://github.com/BlackBeetleHub/go/releases) of the federation server are available on the [releases page](https://github.com/BlackBeetleHub/go/releases).
...
```
go get -u github.com/BlackBeetleHub/go/services/federation
```
